import{p as S,aX as v,w as T,y as R,b0 as A,q as B,G as C,F as c,D as a,E as l,as as L,aB as N,g as P}from"./vendor-CCKyVpFH.js";import{G as $}from"./GoBack-CI3ta7zR.js";import{i as h,T as D,d as I}from"../index-CzqyqUL1.js";import{R as x}from"./ReusableDataTable-dGG6DEmF.js";import{H as d,i,f as m,d as F,l as H,_ as O}from"./encounter_type-B1BBq7-M.js";import U from"./CPR-46oUJ4up.js";import{s as k}from"./pinia-CHgklrPM.js";import{u as E}from"./useAETCStageRealtime-CJelRNQk.js";const G=S({__name:"ScreeningList",setup(J){const s=P([]),u=v(),b=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Attended By","Action"],f={responsive:!0,ordering:!1,buttons:[]},o=h(),{AETCScreeningList:r}=k(o),e=()=>{s.value=r.value.map(t=>[t.visit_number,t.given_name,t.family_name,d.toStandardHisTimeFormat(t.arrival_time),d.waitingTime(t.latest_encounter_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id})])},{setupStageRealtimeUpdates:p,teardownStageRealtimeUpdates:g}=E({onUpdated:e}),_=t=>`
