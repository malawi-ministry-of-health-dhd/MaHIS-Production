import{p as y,aX as v,w as R,y as S,b0 as A,q as B,G as C,F as l,D as a,E as d,as as L,aB as N,g as P}from"./vendor-BHih14ng.js";import{G as $}from"./GoBack-D1hD-o8Q.js";import{i as h,T as D,d as I}from"../index-BT2zcl8Y.js";import{R as k}from"./ReusableDataTable-BZ1gqYWM.js";import{H as n,i as s,f as m,d as x,k as F,_ as H}from"./encounter_type-Bd6E_5mX.js";import O from"./CPR-H18mjS-d.js";import{s as U}from"./pinia-DepOfgUz.js";import{u as E}from"./useAETCStageRealtime-C_69vj8h.js";const G=y({__name:"TriageList",setup(J){const o=P([]),u=v(),b=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Aggregate","Registered By","Action"],p={responsive:!0,ordering:!1,buttons:[]},r=h(),{AETCTriageList:c}=U(r),e=()=>{o.value=c.value.map(t=>[t.visit_number,t.given_name,t.family_name,n.toStandardHisTimeFormat(t.arrival_time),n.waitingTime(t.latest_encounter_time),n.waitingTime(t.arrival_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id})])},{setupStageRealtimeUpdates:f,teardownStageRealtimeUpdates:g}=E({onUpdated:e}),_=t=>`
