import{p as T,aV as v,w as R,y as S,a_ as A,q as P,G as C,F as l,D as a,E as d,aq as L,ay as N,g as $}from"./vendor-JvOur737.js";import{G as B}from"./GoBack-B8zsUmWi.js";import{f as h,T as D,g as I}from"../index-csHA2j58.js";import{R as x}from"./ReusableDataTable-AMk5pbIF.js";import{H as n,i as s,P as m,d as F,j as H,_ as O}from"./encounter_type-DJ_W6a9G.js";import U from"./CPR-BgCsrnht.js";import{s as V}from"./pinia-CItOynZS.js";import{u as k}from"./useAETCStageRealtime-DQJ7j1iv.js";const E=T({__name:"TriageList",setup(G){const o=$([]),u=v(),b=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Aggregate","Registered By","Action"],p={responsive:!0,ordering:!1,buttons:[]},r=h(),{AETCTriageList:c}=V(r),e=()=>{o.value=c.value.map(t=>[t.visit_number,t.given_name,t.family_name,n.toStandardHisTimeFormat(t.arrival_time),n.waitingTime(t.latest_encounter_time),n.waitingTime(t.arrival_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id})])},{setupStageRealtimeUpdates:f,teardownStageRealtimeUpdates:g}=k({onUpdated:e}),_=t=>`
