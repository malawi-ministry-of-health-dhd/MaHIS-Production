import{p as v,aV as R,w as S,y as T,a_ as h,q as A,G as C,F as m,D as i,E as d,aq as L,az as N,g as $}from"./vendor-DnALXmE4.js";import{G as B}from"./GoBack-Cl8kcEcM.js";import{i as D,T as P,d as I}from"../index-CClL4SoD.js";import{R as k}from"./ReusableDataTable-C7pPQHx5.js";import{h as x,H as n,i as s,d as F,k as H,f as O,_ as U}from"./encounter_type-Bw9b0Tp7.js";import V from"./CPR-BstzRvgi.js";import{s as E}from"./pinia-CIieWJbU.js";import{u as G}from"./useAETCStageRealtime-4Npieo-u.js";const J=v({__name:"RegistrationList",setup(q){const o=$([]),l=R(),u=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Aggregate","Screened By","Action"],b=x(),p={responsive:!0,ordering:!1,buttons:[]},r=D(),{AETCRegistrationList:c}=E(r),a=()=>{o.value=c.value.map(t=>[t.visit_number,t.given_name,t.family_name,n.toStandardHisTimeFormat(t.arrival_time),n.waitingTime(t.updated_at),n.waitingTime(t.arrival_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id,given_name:t?.given_name,family_name:t?.family_name})])},{setupStageRealtimeUpdates:f,teardownStageRealtimeUpdates:g}=G({onUpdated:a}),_=t=>`
