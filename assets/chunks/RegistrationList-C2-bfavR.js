import{p as v,aV as R,w as S,y as T,a_ as h,q as A,G as C,F as m,D as i,E as d,aq as L,az as N,g as $}from"./vendor-CkRy3rQ5.js";import{G as B}from"./GoBack-bX6gTM3x.js";import{i as D,T as P,d as I}from"../index-D8UyWEjg.js";import{R as k}from"./ReusableDataTable-B2ZTq006.js";import{h as x,H as n,i as s,d as F,k as H,f as O,_ as U}from"./encounter_type-CwPloeyE.js";import V from"./CPR-PhjQmCdT.js";import{s as E}from"./pinia-Brf5NvUw.js";import{u as G}from"./useAETCStageRealtime-TAgQR6Eu.js";const J=v({__name:"RegistrationList",setup(q){const o=$([]),l=R(),u=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Aggregate","Screened By","Action"],b=x(),p={responsive:!0,ordering:!1,buttons:[]},r=D(),{AETCRegistrationList:c}=E(r),a=()=>{o.value=c.value.map(t=>[t.visit_number,t.given_name,t.family_name,n.toStandardHisTimeFormat(t.arrival_time),n.waitingTime(t.updated_at),n.waitingTime(t.arrival_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id,given_name:t?.given_name,family_name:t?.family_name})])},{setupStageRealtimeUpdates:f,teardownStageRealtimeUpdates:g}=G({onUpdated:a}),_=t=>`
