import{p as y,aV as v,w as R,y as S,a_ as A,q as P,G as C,F as l,D as a,E as d,aq as L,az as N,g as $}from"./vendor-BlvC9i8U.js";import{G as B}from"./GoBack-BzRvUfGC.js";import{f as h,T as D,g as I}from"../index-Cw0iTfKG.js";import{R as x}from"./ReusableDataTable-CyNi9tQn.js";import{H as n,i as s,P as m,d as F,j as H,_ as O}from"./encounter_type-7tIxNB04.js";import U from"./CPR-voia-wDT.js";import{s as V}from"./pinia-CDIrdFtB.js";import{u as k}from"./useAETCStageRealtime-D18p-z7c.js";const E=y({__name:"TriageList",setup(G){const o=$([]),u=v(),b=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Aggregate","Registered By","Action"],p={responsive:!0,ordering:!1,buttons:[]},r=h(),{AETCTriageList:c}=V(r),e=()=>{o.value=c.value.map(t=>[t.visit_number,t.given_name,t.family_name,n.toStandardHisTimeFormat(t.arrival_time),n.waitingTime(t.latest_encounter_time),n.waitingTime(t.arrival_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id})])},{setupStageRealtimeUpdates:f,teardownStageRealtimeUpdates:g}=k({onUpdated:e}),_=t=>`
