import{p as S,aV as v,w as T,y as R,a_ as A,q as C,G as L,F as c,D as a,E as l,aq as N,az as P,g as $}from"./vendor-DbEPR--q.js";import{G as B}from"./GoBack-Ag-aUDlT.js";import{i as h,T as D,d as I}from"../index-CSvEnuOy.js";import{R as k}from"./ReusableDataTable-D6D6z1ff.js";import{H as d,i,f as m,d as x,k as F,_ as H}from"./encounter_type-BQMpkAPk.js";import O from"./CPR-BObwh9jb.js";import{s as U}from"./pinia-Cedi3lLi.js";import{u as V}from"./useAETCStageRealtime-8iHqFNbx.js";const E=S({__name:"ScreeningList",setup(G){const s=$([]),u=v(),b=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Attended By","Action"],f={responsive:!0,ordering:!1,buttons:[]},o=h(),{AETCScreeningList:r}=U(o),e=()=>{s.value=r.value.map(t=>[t.visit_number,t.given_name,t.family_name,d.toStandardHisTimeFormat(t.arrival_time),d.waitingTime(t.latest_encounter_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id})])},{setupStageRealtimeUpdates:p,teardownStageRealtimeUpdates:g}=V({onUpdated:e}),_=t=>`
