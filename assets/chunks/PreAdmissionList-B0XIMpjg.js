import{p as $,aX as x,a$ as T,e5 as A,q as C,G as O,F as p,D as r,E as b,as as B,aB as W,g as k,c as o}from"./vendor-CCKyVpFH.js";import{T as L,P as q}from"../index-Ch_cI04U.js";import{R as E}from"./ReusableDataTable-3yjU_iTE.js";import{G}from"./GoBack-W_XBE6Ps.js";import{j as w,e as H,r as J,d as M,f as V,H as f,i as _,_ as F}from"./encounter_type-BV-B6dIQ.js";import X from"./CPR-B_hx4NQJ.js";const j="ipdToolbarContext",K=$({__name:"PreAdmissionList",setup(Y){const d=x(),c=T(),v=w(),m=k([]),g=["Visit No","First Name","Last Name","MRN","Gender","Arrival Time","Waiting Time","Ward","Actions"],I={responsive:!0,ordering:!1,buttons:[]},l=(()=>{try{return JSON.parse(localStorage.getItem(j)||"{}")}catch{return{}}})(),y=o(()=>String(c.query.department||l.department||"").trim()),s=o(()=>String(c.query.ward||l.ward||"").trim()),u=o(()=>String(c.query.wardId||l.wardId||"").trim()),P=o(()=>`Patients Awaiting Admission${s.value?` - ${s.value}`:""}`),S=e=>`
