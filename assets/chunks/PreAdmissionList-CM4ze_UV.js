import{p as x,aV as T,aZ as $,ea as A,q as C,G as O,F as p,D as r,E as b,aq as B,az as W,g as k,c as o}from"./vendor-CEQFE9XW.js";import{T as q,E}from"../index-CiedhS-1.js";import{R as L}from"./ReusableDataTable-Cqo5APDj.js";import{G}from"./GoBack-CYhNnT2X.js";import{f as V,e as w,m as H,d as J,P as M,H as f,i as _,_ as F}from"./encounter_type-BifXzniq.js";import z from"./CPR-qs3jHKlp.js";const K="ipdToolbarContext",X=x({__name:"PreAdmissionList",setup(Y){const d=T(),c=$(),v=V(),m=k([]),g=["Visit No","First Name","Last Name","MRN","Gender","Arrival Time","Waiting Time","Ward","Actions"],I={responsive:!0,ordering:!1,buttons:[]},l=(()=>{try{return JSON.parse(localStorage.getItem(K)||"{}")}catch{return{}}})(),y=o(()=>String(c.query.department||l.department||"").trim()),s=o(()=>String(c.query.ward||l.ward||"").trim()),u=o(()=>String(c.query.wardId||l.wardId||"").trim()),P=o(()=>`Patients Awaiting Admission${s.value?` - ${s.value}`:""}`),S=e=>`
