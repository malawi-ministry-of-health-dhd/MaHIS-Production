import{p as y,aX as v,w as R,y as S,b0 as A,q as B,G as C,F as l,D as a,E as d,as as L,aB as N,g as P}from"./vendor-BvgHoacB.js";import{G as $}from"./GoBack-CXKsqQwf.js";import{i as h,T as D,d as I}from"../index-BjOHoz9W.js";import{R as x}from"./ReusableDataTable-fnhhOV3F.js";import{H as n,i as s,f as m,d as F,l as H,_ as O}from"./encounter_type-hw0r7mat.js";import U from"./CPR-BYRJT7lO.js";import{s as k}from"./pinia-CDk1hFO0.js";import{u as E}from"./useAETCStageRealtime-CGW3cqWY.js";const G=y({__name:"TriageList",setup(J){const o=P([]),u=v(),b=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Aggregate","Registered By","Action"],p={responsive:!0,ordering:!1,buttons:[]},r=h(),{AETCTriageList:c}=k(r),e=()=>{o.value=c.value.map(t=>[t.visit_number,t.given_name,t.family_name,n.toStandardHisTimeFormat(t.arrival_time),n.waitingTime(t.latest_encounter_time),n.waitingTime(t.arrival_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id})])},{setupStageRealtimeUpdates:f,teardownStageRealtimeUpdates:g}=E({onUpdated:e}),_=t=>`
