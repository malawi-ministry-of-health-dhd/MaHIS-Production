import{p as x,aV as C,aZ as T,e9 as $,q as A,G as O,F as p,D as r,E as b,aq as B,az as W,g as k,c as o}from"./vendor-_TlKefwF.js";import{T as q,C as L}from"../index-l6h4cg02.js";import{R as E}from"./ReusableDataTable-CsntIu0K.js";import{G}from"./GoBack-Clmml1d_.js";import{f as V,e as w,m as H,d as J,P as M,H as f,i as _,_ as F}from"./encounter_type-Cc4eRC2p.js";import z from"./CPR-BEp-6m73.js";const K="ipdToolbarContext",X=x({__name:"PreAdmissionList",setup(Y){const d=C(),c=T(),v=V(),m=k([]),g=["Visit No","First Name","Last Name","MRN","Gender","Arrival Time","Waiting Time","Ward","Actions"],I={responsive:!0,ordering:!1,buttons:[]},l=(()=>{try{return JSON.parse(localStorage.getItem(K)||"{}")}catch{return{}}})(),y=o(()=>String(c.query.department||l.department||"").trim()),s=o(()=>String(c.query.ward||l.ward||"").trim()),u=o(()=>String(c.query.wardId||l.wardId||"").trim()),P=o(()=>`Patients Awaiting Admission${s.value?` - ${s.value}`:""}`),S=e=>`
