import{p as R,aV as T,bx as $,y as A,q as C,G as O,F as p,D as r,E as b,aq as B,ay as k,g as q,c as o}from"./vendor-CAOSv2lG.js";import{T as L,bX as W,y as G}from"../index-D7KxR7KU.js";import{R as M}from"./ReusableDataTable-DpirnQ8D.js";import{G as E}from"./GoBack-C5PubkJA.js";import{f as H,e as J,d as V,P as w,H as f,i as _,_ as F}from"./encounter_type-J5FmQuzO.js";import X from"./CPR-BxbS4NRw.js";const K="ipdToolbarContext",Y=R({__name:"PreAdmissionList",setup(j){const d=T(),c=$(),v=H(),m=q([]),g=["Visit No","First Name","Last Name","MRN","Gender","Arrival Time","Waiting Time","Ward","Actions"],I={responsive:!0,ordering:!1,buttons:[]},u=(()=>{try{return JSON.parse(localStorage.getItem(K)||"{}")}catch{return{}}})(),y=o(()=>String(c.query.department||u.department||"").trim()),s=o(()=>String(c.query.ward||u.ward||"").trim()),l=o(()=>String(c.query.wardId||u.wardId||"").trim()),P=o(()=>`Patients Awaiting Admission${s.value?` - ${s.value}`:""}`),S=e=>`
