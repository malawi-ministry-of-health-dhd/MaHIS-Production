import{p as S,aV as v,w as T,y as R,a_ as A,q as C,G as L,F as c,D as a,E as l,aq as N,az as P,g as $}from"./vendor-DnALXmE4.js";import{G as B}from"./GoBack-C3eoqYRu.js";import{i as h,T as D,d as I}from"../index-CnCvwMOi.js";import{R as k}from"./ReusableDataTable-BH1cyqHD.js";import{H as d,i,f as m,d as x,k as F,_ as H}from"./encounter_type-t3iDdyN3.js";import O from"./CPR-CpHPmysm.js";import{s as U}from"./pinia-CIieWJbU.js";import{u as V}from"./useAETCStageRealtime-BHAMguoo.js";const E=S({__name:"ScreeningList",setup(G){const s=$([]),u=v(),b=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Attended By","Action"],f={responsive:!0,ordering:!1,buttons:[]},o=h(),{AETCScreeningList:r}=U(o),e=()=>{s.value=r.value.map(t=>[t.visit_number,t.given_name,t.family_name,d.toStandardHisTimeFormat(t.arrival_time),d.waitingTime(t.latest_encounter_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id})])},{setupStageRealtimeUpdates:p,teardownStageRealtimeUpdates:g}=V({onUpdated:e}),_=t=>`
