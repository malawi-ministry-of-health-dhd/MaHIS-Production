import{p as x,aV as T,aZ as $,e1 as A,q as C,G as O,F as p,D as r,E as b,aq as q,az as B,g as W,c as o}from"./vendor-Puu7tX6q.js";import{T as k,P as L}from"../index-BnBxAscF.js";import{R as E}from"./ReusableDataTable-DLvsUcB4.js";import{G}from"./GoBack-BvPIi8In.js";import{h as V,e as w,q as H,d as J,f as M,H as f,i as _,_ as F}from"./encounter_type-DE2iS6or.js";import z from"./CPR-ZjtGMoN7.js";const K="ipdToolbarContext",X=x({__name:"PreAdmissionList",setup(Y){const d=T(),c=$(),v=V(),m=W([]),g=["Visit No","First Name","Last Name","MRN","Gender","Arrival Time","Waiting Time","Ward","Actions"],I={responsive:!0,ordering:!1,buttons:[]},l=(()=>{try{return JSON.parse(localStorage.getItem(K)||"{}")}catch{return{}}})(),y=o(()=>String(c.query.department||l.department||"").trim()),s=o(()=>String(c.query.ward||l.ward||"").trim()),u=o(()=>String(c.query.wardId||l.wardId||"").trim()),P=o(()=>`Patients Awaiting Admission${s.value?` - ${s.value}`:""}`),S=e=>`
