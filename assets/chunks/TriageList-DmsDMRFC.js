import{d as y,a3 as v,M as R,B as S,b4 as A,c as L,w as c,a as l,G as P,L as B,o as C,e as a,V as N,a2 as $}from"./navigation-BglLrznb.js";import{G as h}from"./GoBack-Cltg5u1e.js";import{T as I}from"./Toolbar-BEfvB9gi.js";import{R as x}from"./ReusableDataTable-Cv5OA_au.js";import{i as n}from"./svg-COr7WdNJ.js";import{createModal as D,alertConfirmation as H}from"./Alerts-DIsW0NSB.js";import O from"./CPR-DjaOcLCZ.js";import{P as d}from"./observation_service-De3fBB74.js";import{closeVisit as U}from"./visits_service-B3slCk5s.js";import{H as o}from"./service-_L9DyH01.js";import{usePatientList as V}from"./patientListStore-rkCRUqpb.js";import{u as k}from"./useAETCStageRealtime-DvJ6SjH-.js";import{_ as F}from"./_plugin-vue_export-helper-DlAUqK2U.js";const G=y({__name:"TriageList",setup(J){const s=P([]),u=B(),b=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Aggregate","Registered By","Action"],p={responsive:!0,ordering:!1,buttons:[]},r=V(),{AETCTriageList:m}=v(r),e=()=>{s.value=m.value.map(t=>[t.visit_number,t.given_name,t.family_name,o.toStandardHisTimeFormat(t.arrival_time),o.waitingTime(t.latest_encounter_time),o.waitingTime(t.arrival_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id})])},{setupStageRealtimeUpdates:f,teardownStageRealtimeUpdates:g}=k({onUpdated:e}),_=t=>`
