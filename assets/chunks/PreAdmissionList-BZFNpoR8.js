import{p as x,aV as T,bz as $,y as A,q as C,G as O,F as p,D as r,E as b,aq as B,ay as W,g as k,c as o}from"./vendor-CLc3GWSf.js";import{T as q,bW as L}from"../index-C_C6wNt6.js";import{R as G}from"./ReusableDataTable-H5vMJx77.js";import{G as M}from"./GoBack-ByZS8O2A.js";import{f as E,e as H,m as J,d as V,P as w,H as f,i as _,_ as F}from"./encounter_type-mzO7R8no.js";import z from"./CPR-Bc0nB6fi.js";const K="ipdToolbarContext",X=x({__name:"PreAdmissionList",setup(Y){const d=T(),c=$(),v=E(),m=k([]),g=["Visit No","First Name","Last Name","MRN","Gender","Arrival Time","Waiting Time","Ward","Actions"],I={responsive:!0,ordering:!1,buttons:[]},u=(()=>{try{return JSON.parse(localStorage.getItem(K)||"{}")}catch{return{}}})(),y=o(()=>String(c.query.department||u.department||"").trim()),s=o(()=>String(c.query.ward||u.ward||"").trim()),l=o(()=>String(c.query.wardId||u.wardId||"").trim()),P=o(()=>`Patients Awaiting Admission${s.value?` - ${s.value}`:""}`),S=e=>`
