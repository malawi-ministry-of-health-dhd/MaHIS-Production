import{p as S,aV as v,w as T,y as R,a_ as A,q as P,G as C,F as c,D as a,E as l,aq as L,az as N,g as $}from"./vendor-DjkbOKii.js";import{G as B}from"./GoBack-B9qB_A1Q.js";import{f as h,T as D,g as I}from"../index-CgiNq7Ga.js";import{R as x}from"./ReusableDataTable-DX2vHoWG.js";import{H as d,i,P as m,d as F,j as H,_ as O}from"./encounter_type-BDQDR8__.js";import U from"./CPR-FNm2SBMw.js";import{s as V}from"./pinia-BU5cOtVP.js";import{u as k}from"./useAETCStageRealtime-BIVo59V0.js";const E=S({__name:"ScreeningList",setup(G){const s=$([]),u=v(),b=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Attended By","Action"],f={responsive:!0,ordering:!1,buttons:[]},o=h(),{AETCScreeningList:r}=V(o),e=()=>{s.value=r.value.map(t=>[t.visit_number,t.given_name,t.family_name,d.toStandardHisTimeFormat(t.arrival_time),d.waitingTime(t.latest_encounter_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id})])},{setupStageRealtimeUpdates:p,teardownStageRealtimeUpdates:g}=k({onUpdated:e}),_=t=>`
