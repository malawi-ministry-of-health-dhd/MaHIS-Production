import{p as y,aV as v,w as R,y as S,a_ as A,q as C,G as L,F as l,D as a,E as d,aq as N,az as P,g as $}from"./vendor-DnALXmE4.js";import{G as B}from"./GoBack-BuM61tTC.js";import{i as h,T as D,d as I}from"../index-CO4SsUAc.js";import{R as k}from"./ReusableDataTable-Uz25ttGb.js";import{H as n,i as s,f as m,d as x,k as F,_ as H}from"./encounter_type-BU0qL2Dz.js";import O from"./CPR-CFvbOoWb.js";import{s as U}from"./pinia-CIieWJbU.js";import{u as V}from"./useAETCStageRealtime-DQf4VlBY.js";const E=y({__name:"TriageList",setup(G){const o=$([]),u=v(),b=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Aggregate","Registered By","Action"],p={responsive:!0,ordering:!1,buttons:[]},r=h(),{AETCTriageList:c}=U(r),e=()=>{o.value=c.value.map(t=>[t.visit_number,t.given_name,t.family_name,n.toStandardHisTimeFormat(t.arrival_time),n.waitingTime(t.latest_encounter_time),n.waitingTime(t.arrival_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id})])},{setupStageRealtimeUpdates:f,teardownStageRealtimeUpdates:g}=V({onUpdated:e}),_=t=>`
