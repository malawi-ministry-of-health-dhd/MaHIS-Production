import{p as S,a_ as v,w as T,y as R,ak as A,q as C,G as L,F as c,D as a,E as l,at as N,aC as P,g as $}from"./vendor-DbhrX6_N.js";import{G as B}from"./GoBack-DBZtt6dU.js";import{i as h,T as D,d as I}from"../index-C6G4mHGR.js";import{R as k}from"./ReusableDataTable-CTgciHGX.js";import{H as d,i,f as m,d as x,l as F,_ as H}from"./encounter_type-C_xVEJQ7.js";import O from"./CPR-BSmo21jE.js";import{s as U}from"./pinia-DVZah_rs.js";import{u as E}from"./useAETCStageRealtime-4tX3t4OO.js";const G=S({__name:"ScreeningList",setup(J){const s=$([]),u=v(),b=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Attended By","Action"],f={responsive:!0,ordering:!1,buttons:[]},o=h(),{AETCScreeningList:r}=U(o),e=()=>{s.value=r.value.map(t=>[t.visit_number,t.given_name,t.family_name,d.toStandardHisTimeFormat(t.arrival_time),d.waitingTime(t.latest_encounter_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id})])},{setupStageRealtimeUpdates:p,teardownStageRealtimeUpdates:g}=E({onUpdated:e}),_=t=>`
