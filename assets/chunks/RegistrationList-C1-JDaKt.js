import{p as v,aV as R,w as S,y as T,aZ as h,q as A,G as C,F as m,D as n,E as l,aq as L,ay as N,g as P}from"./vendor-B4Zize93.js";import{G as $}from"./GoBack-5NKeNoPG.js";import{f as B,T as D,g as I}from"../index-BXu3I3qC.js";import{R as x}from"./ReusableDataTable-Bl9pDbVJ.js";import{f as F,H as i,i as s,d as H,j as O,P as U,_ as V}from"./encounter_type-0CP5ZxiO.js";import k from"./CPR-B8li341C.js";import{s as E}from"./pinia-D4daA5MV.js";import{u as G}from"./useAETCStageRealtime-D8C7RHkV.js";const J=v({__name:"RegistrationList",setup(q){const o=P([]),d=R(),u=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Aggregate","Screened By","Action"],b=F(),p={responsive:!0,ordering:!1,buttons:[]},r=B(),{AETCRegistrationList:c}=E(r),a=()=>{o.value=c.value.map(t=>[t.visit_number,t.given_name,t.family_name,i.toStandardHisTimeFormat(t.arrival_time),i.waitingTime(t.updated_at),i.waitingTime(t.arrival_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id,given_name:t?.given_name,family_name:t?.family_name})])},{setupStageRealtimeUpdates:f,teardownStageRealtimeUpdates:g}=G({onUpdated:a}),_=t=>`
