import{p as $,aV as x,aZ as T,d$ as A,q as C,G as O,F as p,D as r,E as b,aq as q,az as B,g as W,c as o}from"./vendor-eIV-Tnvr.js";import{T as k,P as L}from"../index-CYdpPkS0.js";import{R as E}from"./ReusableDataTable-Dm95f5Iv.js";import{G}from"./GoBack-BW0hUgBe.js";import{h as V,e as w,q as H,d as J,f as M,H as f,i as _,_ as F}from"./encounter_type-DIug7-TH.js";import z from"./CPR-BD996rY7.js";const K="ipdToolbarContext",X=$({__name:"PreAdmissionList",setup(Y){const d=x(),c=T(),v=V(),m=W([]),g=["Visit No","First Name","Last Name","MRN","Gender","Arrival Time","Waiting Time","Ward","Actions"],I={responsive:!0,ordering:!1,buttons:[]},l=(()=>{try{return JSON.parse(localStorage.getItem(K)||"{}")}catch{return{}}})(),y=o(()=>String(c.query.department||l.department||"").trim()),s=o(()=>String(c.query.ward||l.ward||"").trim()),u=o(()=>String(c.query.wardId||l.wardId||"").trim()),P=o(()=>`Patients Awaiting Admission${s.value?` - ${s.value}`:""}`),S=e=>`
