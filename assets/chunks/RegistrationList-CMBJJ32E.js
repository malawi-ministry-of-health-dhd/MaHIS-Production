import{p as v,aV as R,w as S,y as T,a_ as h,q as A,G as C,F as m,D as i,E as d,aq as L,az as N,g as P}from"./vendor-BT9RBXwx.js";import{G as $}from"./GoBack-CdtzoEWj.js";import{i as B,T as D,d as I}from"../index-0F82NpJl.js";import{R as x}from"./ReusableDataTable-LsRqGbRB.js";import{f as F,H as n,i as s,d as H,j as O,P as U,_ as V}from"./encounter_type-C1VNLiyt.js";import k from"./CPR-BUqVZcQT.js";import{s as E}from"./pinia-BRRJo76B.js";import{u as G}from"./useAETCStageRealtime-D0XcUQ9D.js";const J=v({__name:"RegistrationList",setup(q){const o=P([]),l=R(),u=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Aggregate","Screened By","Action"],b=F(),p={responsive:!0,ordering:!1,buttons:[]},r=B(),{AETCRegistrationList:c}=E(r),a=()=>{o.value=c.value.map(t=>[t.visit_number,t.given_name,t.family_name,n.toStandardHisTimeFormat(t.arrival_time),n.waitingTime(t.updated_at),n.waitingTime(t.arrival_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id,given_name:t?.given_name,family_name:t?.family_name})])},{setupStageRealtimeUpdates:f,teardownStageRealtimeUpdates:g}=G({onUpdated:a}),_=t=>`
