import{p as v,aV as R,w as S,y as T,a_ as h,q as A,G as C,F as m,D as n,E as d,aq as L,az as N,g as P}from"./vendor-CIQlHI4N.js";import{G as $}from"./GoBack-BTiZ9qMD.js";import{j as B,T as D,d as I}from"../index-B7vCvNB4.js";import{R as x}from"./ReusableDataTable-BRuoZmpZ.js";import{f as F,H as i,i as s,d as H,j as O,P as U,_ as V}from"./encounter_type-Dd1DxiPJ.js";import k from"./CPR-Bu2j-pSO.js";import{s as E}from"./pinia-BoeYwVct.js";import{u as G}from"./useAETCStageRealtime-DY9_QvJp.js";const J=v({__name:"RegistrationList",setup(j){const o=P([]),l=R(),u=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Aggregate","Screened By","Action"],b=F(),p={responsive:!0,ordering:!1,buttons:[]},r=B(),{AETCRegistrationList:c}=E(r),a=()=>{o.value=c.value.map(t=>[t.visit_number,t.given_name,t.family_name,i.toStandardHisTimeFormat(t.arrival_time),i.waitingTime(t.updated_at),i.waitingTime(t.arrival_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id,given_name:t?.given_name,family_name:t?.family_name})])},{setupStageRealtimeUpdates:f,teardownStageRealtimeUpdates:g}=G({onUpdated:a}),_=t=>`
