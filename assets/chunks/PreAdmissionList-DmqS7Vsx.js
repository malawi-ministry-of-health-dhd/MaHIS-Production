import{d as x,a4 as T,c as $,w as p,a as f,h as r,G as A,L as C,u as O,o as B,e as o,V as L,a2 as W}from"./navigation-BglLrznb.js";import{T as k}from"./Toolbar-BEfvB9gi.js";import{R as w}from"./ReusableDataTable-Cv5OA_au.js";import{G}from"./GoBack-Cltg5u1e.js";import{createModal as V}from"./Alerts-DIsW0NSB.js";import{i as b}from"./svg-COr7WdNJ.js";import{P as q}from"./patient_opd_list-C5RoEVfb.js";import{P as E,H as _}from"./service-_L9DyH01.js";import{P as H}from"./observation_service-De3fBB74.js";import{useDemographicsStore as J}from"./DemographicStore-_cx_NFor.js";import M from"./CPR-DjaOcLCZ.js";import{toastWarning as F}from"./toasts-DaA7oCoV.js";import{_ as K}from"./_plugin-vue_export-helper-DlAUqK2U.js";const X="ipdToolbarContext",Y=x({__name:"PreAdmissionList",setup(j){const d=C(),m=O(),v=J(),c=A([]),g=["Visit No","First Name","Last Name","MRN","Gender","Arrival Time","Waiting Time","Ward","Actions"],I={responsive:!0,ordering:!1,buttons:[]},l=(()=>{try{return JSON.parse(localStorage.getItem(X)||"{}")}catch{return{}}})(),P=r(()=>String(m.query.department||l.department||"").trim()),s=r(()=>String(m.query.ward||l.ward||"").trim()),u=r(()=>String(m.query.wardId||l.wardId||"").trim()),y=r(()=>`Patients Awaiting Admission${s.value?` - ${s.value}`:""}`),S=e=>`
