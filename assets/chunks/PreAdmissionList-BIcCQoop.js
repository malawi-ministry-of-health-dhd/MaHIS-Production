import{p as x,aZ as T,b1 as $,e6 as A,q as C,G as O,F as p,D as r,E as b,as as B,aB as W,g as k,c as o}from"./vendor-CHp07Sex.js";import{T as L,P as q}from"../index-DYFIwsBJ.js";import{R as E}from"./ReusableDataTable-B_xSE5lL.js";import{G}from"./GoBack-BMGoAsBi.js";import{j as w,e as H,r as J,d as M,f as V,H as f,i as _,_ as F}from"./encounter_type-B47EfQCH.js";import j from"./CPR-gzHkNaVg.js";const K="ipdToolbarContext",X=x({__name:"PreAdmissionList",setup(Y){const d=T(),c=$(),v=w(),m=k([]),g=["Visit No","First Name","Last Name","MRN","Gender","Arrival Time","Waiting Time","Ward","Actions"],I={responsive:!0,ordering:!1,buttons:[]},l=(()=>{try{return JSON.parse(localStorage.getItem(K)||"{}")}catch{return{}}})(),y=o(()=>String(c.query.department||l.department||"").trim()),s=o(()=>String(c.query.ward||l.ward||"").trim()),u=o(()=>String(c.query.wardId||l.wardId||"").trim()),P=o(()=>`Patients Awaiting Admission${s.value?` - ${s.value}`:""}`),S=e=>`
