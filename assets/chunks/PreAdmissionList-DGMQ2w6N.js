import{p as x,aV as T,aZ as $,y as A,q as C,G as O,F as p,D as r,E as b,aq as B,ay as k,g as q,c as o}from"./vendor-C9PcrAKO.js";import{T as L,b_ as W}from"../index-qHqTwiFF.js";import{R as G}from"./ReusableDataTable-BBLyAEF1.js";import{G as M}from"./GoBack-CFBahFAI.js";import{f as E,e as H,m as J,d as V,P as w,H as f,i as _,_ as F}from"./encounter_type-D6CztgTP.js";import K from"./CPR-CbSmi64y.js";const X="ipdToolbarContext",Y=x({__name:"PreAdmissionList",setup(Z){const d=T(),c=$(),v=E(),m=q([]),g=["Visit No","First Name","Last Name","MRN","Gender","Arrival Time","Waiting Time","Ward","Actions"],I={responsive:!0,ordering:!1,buttons:[]},u=(()=>{try{return JSON.parse(localStorage.getItem(X)||"{}")}catch{return{}}})(),y=o(()=>String(c.query.department||u.department||"").trim()),s=o(()=>String(c.query.ward||u.ward||"").trim()),l=o(()=>String(c.query.wardId||u.wardId||"").trim()),P=o(()=>`Patients Awaiting Admission${s.value?` - ${s.value}`:""}`),S=e=>`
