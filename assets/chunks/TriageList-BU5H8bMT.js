import{p as y,aV as v,w as R,y as S,a_ as A,q as C,G as L,F as l,D as a,E as d,aq as N,az as P,g as $}from"./vendor-D7gKAt1t.js";import{G as B}from"./GoBack-Clt-neh5.js";import{i as h,T as D,d as I}from"../index-hMePvZGU.js";import{R as k}from"./ReusableDataTable-CqfxW4XO.js";import{H as n,i as s,f as m,d as x,k as F,_ as H}from"./encounter_type-DAAOX_zC.js";import O from"./CPR-Cqiea1sd.js";import{s as U}from"./pinia-CIcJPgNC.js";import{u as V}from"./useAETCStageRealtime-CyKg0REV.js";const E=y({__name:"TriageList",setup(G){const o=$([]),u=v(),b=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Aggregate","Registered By","Action"],p={responsive:!0,ordering:!1,buttons:[]},r=h(),{AETCTriageList:c}=U(r),e=()=>{o.value=c.value.map(t=>[t.visit_number,t.given_name,t.family_name,n.toStandardHisTimeFormat(t.arrival_time),n.waitingTime(t.latest_encounter_time),n.waitingTime(t.arrival_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id})])},{setupStageRealtimeUpdates:f,teardownStageRealtimeUpdates:g}=V({onUpdated:e}),_=t=>`
