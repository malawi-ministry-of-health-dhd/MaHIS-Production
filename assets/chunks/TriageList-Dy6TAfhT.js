import{p as y,a_ as v,w as R,y as S,ak as A,q as C,G as L,F as l,D as a,E as d,at as N,aC as P,g as $}from"./vendor-DbhrX6_N.js";import{G as B}from"./GoBack-DBZtt6dU.js";import{i as h,T as D,d as I}from"../index-C6G4mHGR.js";import{R as k}from"./ReusableDataTable-CTgciHGX.js";import{H as n,i as s,f as m,d as x,l as F,_ as H}from"./encounter_type-C_xVEJQ7.js";import O from"./CPR-BSmo21jE.js";import{s as U}from"./pinia-DVZah_rs.js";import{u as E}from"./useAETCStageRealtime-4tX3t4OO.js";const G=y({__name:"TriageList",setup(J){const o=$([]),u=v(),b=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Aggregate","Registered By","Action"],p={responsive:!0,ordering:!1,buttons:[]},r=h(),{AETCTriageList:c}=U(r),e=()=>{o.value=c.value.map(t=>[t.visit_number,t.given_name,t.family_name,n.toStandardHisTimeFormat(t.arrival_time),n.waitingTime(t.latest_encounter_time),n.waitingTime(t.arrival_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id})])},{setupStageRealtimeUpdates:f,teardownStageRealtimeUpdates:g}=E({onUpdated:e}),_=t=>`
