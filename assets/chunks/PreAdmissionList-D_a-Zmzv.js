import{p as x,aV as T,aZ as $,y as A,q as C,G as O,F as p,D as r,E as b,aq as B,ay as k,g as q,c as o}from"./vendor-CJyWLCaR.js";import{T as L,bZ as W}from"../index-DYuBP6qr.js";import{R as G}from"./ReusableDataTable-B-QLFbAB.js";import{G as M}from"./GoBack-YvkFnx-E.js";import{f as E,e as H,m as J,d as V,P as w,H as f,i as _,_ as F}from"./encounter_type-CgEsP7vZ.js";import Z from"./CPR-CQt1Z817.js";const K="ipdToolbarContext",X=x({__name:"PreAdmissionList",setup(Y){const d=T(),c=$(),v=E(),m=q([]),g=["Visit No","First Name","Last Name","MRN","Gender","Arrival Time","Waiting Time","Ward","Actions"],I={responsive:!0,ordering:!1,buttons:[]},u=(()=>{try{return JSON.parse(localStorage.getItem(K)||"{}")}catch{return{}}})(),y=o(()=>String(c.query.department||u.department||"").trim()),s=o(()=>String(c.query.ward||u.ward||"").trim()),l=o(()=>String(c.query.wardId||u.wardId||"").trim()),P=o(()=>`Patients Awaiting Admission${s.value?` - ${s.value}`:""}`),S=e=>`
