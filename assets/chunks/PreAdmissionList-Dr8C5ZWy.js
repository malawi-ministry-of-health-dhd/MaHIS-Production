import{p as x,aV as C,aZ as T,y as $,q as A,G as O,F as p,D as r,E as b,aq as B,ay as k,g as q,c as o}from"./vendor-Dars2dYK.js";import{T as L,C as W}from"../index-Bvtx7MXj.js";import{R as G}from"./ReusableDataTable-BmsSwQXu.js";import{G as M}from"./GoBack-7zy_4XgA.js";import{f as E,e as H,m as J,d as V,P as w,H as f,i as _,_ as F}from"./encounter_type-f0KSP37x.js";import K from"./CPR-B0z1fY2Z.js";const X="ipdToolbarContext",Y=x({__name:"PreAdmissionList",setup(Z){const d=C(),c=T(),v=E(),m=q([]),g=["Visit No","First Name","Last Name","MRN","Gender","Arrival Time","Waiting Time","Ward","Actions"],I={responsive:!0,ordering:!1,buttons:[]},u=(()=>{try{return JSON.parse(localStorage.getItem(X)||"{}")}catch{return{}}})(),y=o(()=>String(c.query.department||u.department||"").trim()),s=o(()=>String(c.query.ward||u.ward||"").trim()),l=o(()=>String(c.query.wardId||u.wardId||"").trim()),P=o(()=>`Patients Awaiting Admission${s.value?` - ${s.value}`:""}`),S=e=>`
