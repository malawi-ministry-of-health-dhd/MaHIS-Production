import{p as x,aV as T,bz as $,y as A,q as C,G as O,F as p,D as r,E as b,aq as B,ay as k,g as q,c as o}from"./vendor-CLc3GWSf.js";import{T as L,bZ as W,z as G}from"../index-ByM93Jlc.js";import{R as M}from"./ReusableDataTable-DwNeK-bi.js";import{G as E}from"./GoBack-BwJI-bPO.js";import{f as H,e as J,d as V,P as w,H as f,i as _,_ as F}from"./encounter_type-BWLA4v3y.js";import z from"./CPR-8a9HCT0B.js";const K="ipdToolbarContext",X=x({__name:"PreAdmissionList",setup(Y){const d=T(),c=$(),v=H(),m=q([]),g=["Visit No","First Name","Last Name","MRN","Gender","Arrival Time","Waiting Time","Ward","Actions"],I={responsive:!0,ordering:!1,buttons:[]},u=(()=>{try{return JSON.parse(localStorage.getItem(K)||"{}")}catch{return{}}})(),y=o(()=>String(c.query.department||u.department||"").trim()),s=o(()=>String(c.query.ward||u.ward||"").trim()),l=o(()=>String(c.query.wardId||u.wardId||"").trim()),P=o(()=>`Patients Awaiting Admission${s.value?` - ${s.value}`:""}`),S=e=>`
